        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            {bioParagraphs.length > 0 ? (
              ...
              <p className="text-muted-foreground text-[15px] leading-relaxed">Your biography will appear here once you add it to <code>src/data/siteSettings.js</code>.</p>
            )}
            <div className="mt-8">
      ...
      <section className="px-4 md:px-8 py-16 border-t border-border/50">
        <div className="max-w-5xl mx-auto">
          ...
          {loading ? (
            ...
            <EmptyState title="Your education journey will appear here" description="Add education entries to src/data/education.js." />
          )}
        </div>
      </section>
